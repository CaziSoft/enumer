...
func main() {
	...
	for _, typeName := range types {
		g.generate(typeName, *json, *yaml, *sql, *text, *gql, *transformMethod, *trimPrefix, *lineComment)
	}
...
func (g *Generator) generate(typeName string, includeJSON, includeYAML, includeSQL, includeText, includeGQL bool, transformMethod string, trimPrefix string, lineComment bool) {
